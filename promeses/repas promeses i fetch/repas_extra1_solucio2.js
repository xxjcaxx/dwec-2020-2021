    ...
    dibujar() {
        ...
        if (this.numero > 1) {
            ...
            anterior.addEventListener('click', () => {
                mostrarPartidos("Jornada " + (parseInt(this.numero) - 1));
...
function mostrarPartidos(nJornada) {
    JORNADAS = {};
...
(() => {
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        button.addEventListener('click', mostrarPartidos('Jornada 1'));
