import { buildingCard} from '../templates/templates.js';
...
class viewPlanet {
    ...
    viewCard() {
        let plantilla = planetTemplates.planetCard(this.planet); // funció importada
    ...
    viewError() {
        let plantilla = planetTemplates.planetError(this.planet); // funció importada
        let element = document.createElement('div');
        element.classList.add('card');
        element.classList.add('m-1');
        element.style = 'width: 12rem;';
    ...
    viewDetails() {
        ...
        let plantilla = planetTemplates.planetDetails(this.planet);
